    ...
    constructor() {
        ...
        this.properties = [
            ...
            },
            {
                ...
                description: 'Optional comma- or space-separated library list. Prefix with *LIBL to append to the current job library list instead of replacing it.',
            },
            {
                ...
                default: '',
                placeholder: '*SYSBAS',
                description: 'Optional relational database name, typically used when connecting to an independent ASP',
            },
            {
                displayName: 'Access',
                name: 'access',
            ...
            },
            {
                ...
                default: '*DFT',
                description: 'How IBM i should answer inquiry messages for this database job. Default replies avoid MSGW hangs for unattended workflows.',
            },
            {
